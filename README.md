...
[![GoDoc](https://godoc.org/github.com/glaslos/overseer?status.svg)](https://godoc.org/github.com/glaslos/overseer)   [![Tests](https://github.com/glaslos/overseer/workflows/Tests/badge.svg)](https://github.com/glaslos/overseer/actions?workflow=Tests)
...
```sh
go get github.com/glaslos/overseer
```
...
import (
	...
	"github.com/glaslos/overseer"
	"github.com/glaslos/overseer/fetcher"
)
...
See [Config](https://godoc.org/github.com/glaslos/overseer#Config)uration options [here](https://godoc.org/github.com/glaslos/overseer#Config) and the runtime [State](https://godoc.org/github.com/glaslos/overseer#State) available to your program [here](https://godoc.org/github.com/glaslos/overseer#State).
...
* [Core `overseer` package](https://godoc.org/github.com/glaslos/overseer)
* [Common `fetcher.Interface`](https://godoc.org/github.com/glaslos/overseer/fetcher#Interface)
	* [File fetcher](https://godoc.org/github.com/glaslos/overseer/fetcher#File)
	* [HTTP fetcher](https://godoc.org/github.com/glaslos/overseer/fetcher#HTTP)
	* [S3 fetcher](https://godoc.org/github.com/glaslos/overseer/fetcher#S3)
	* [Github fetcher](https://godoc.org/github.com/glaslos/overseer/fetcher#Github)
